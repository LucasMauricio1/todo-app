...
import { BadRequestSwagger } from 'src/helpers/swagger/bad-request';
import { NotFoundSwagger } from 'src/helpers/swagger/not-found';
import {
  IndexTodoSwagger,
  CreateTodoSwagger,
  ShowTodoSwagger,
  UpdateTodoSwagger,
} from './swagger/index.swagger';
...
export class TodoController {
  ...
  async index() {
    return await this.todoService.finAll();
  }
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Exibir os dados uma tarefa.' })
  @ApiResponse({
    status: 200,
